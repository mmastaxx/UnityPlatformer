...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        RaycastHit2D res = Physics2D.BoxCast(new Vector3(transform.position.x+offsetX, transform.position.y,transform.position.z), boxSize, 0, -transform.up, castDistance, ground);
